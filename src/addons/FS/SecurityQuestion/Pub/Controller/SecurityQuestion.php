    ...
    public function actionSave() {
        ...
        //  $order='';
          ...
          foreach($userQuesiton as $question){
           ...
           // if(!in_array($question->question_id,$input['questions'])){
...
//            $addEditQuestion = $this->finder('FS\SecurityQuestion:SecurityQuestionAnswer')->where('question_id', $value)->where('user_id', $visitor->user_id)->fetchOne();
//
//            if ($addEditQuestion) {
//
//                $addEditQuestion->fastUpdate('answer', $input['answers'][$key]);
//
//                continue;
//            }
