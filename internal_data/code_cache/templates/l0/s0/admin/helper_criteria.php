...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__vars['data']['thqaforums_nodetree'] = $__vars['th_nodeTree'];
	$__finalCompiled .= '
	';
	$__vars['app'] = $__vars['xf']['app'];
	$__finalCompiled .= '
	...
	$__vars['page'] = $__templater->preEscaped('
		' . '
	...
	array(
		...
		<h3 class="block-formSectionHeader">
			<span class="collapseTrigger collapseTrigger--block" data-xf-click="toggle" data-target="< :up:next">
				<span class="block-formSectionHeader-aligner"><b>' . 'User field criteria' . '</b></span>
			</span>
		</h3>
	...
	' . $__templater->filter($__vars['page'], array(array('raw', array()),), true) . '
';
	return $__finalCompiled;
}
),
